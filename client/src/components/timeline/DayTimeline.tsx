...
export function DayTimeline() {
  ...
  return (
    <div
      ...
      className="group absolute z-10 flex cursor-move overflow-hidden rounded-t-xl border border-slate-200 bg-white/90 shadow-lg backdrop-blur"
      style={{
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-center border-r border-slate-200 bg-slate-50/80 px-1.5">
        <span className="text-[11px] font-medium tracking-widest text-slate-400" style={{ writingMode: 'vertical-rl' }}>
          日程栏
        </span>
      </div>
